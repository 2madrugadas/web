...
import { initEssayGallery, openEssayPopup, closeEssayPopup } from './essays.js';
import { setupMediaHover, setupGlobalEventListeners, restrictExternalLinks } from './events.js';
...
function startIntroAnimation() {
  ...
  if (document.querySelector('#essays-gallery')) {
    initEssayGallery();
  }
...
window.openEssayPopup = openEssayPopup;
window.closeEssayPopup = closeEssayPopup;